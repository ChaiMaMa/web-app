...
UPDATE Product set productImageURL = '/images/earl grey.jpg' where productId = 3;
UPDATE Product set productImageURL = '/images/English breakfast.jpg' where productId = 4;
...
UPDATE Product set productImageURL = '/images/dragon well.jpg' where productId = 7;
...
UPDATE Product set productImageURL = '/images/white tip.jpg' where productId = 10;
UPDATE Product set productImageURL = '/images/frozen peak.jpg' where productId = 11;
...
UPDATE Product set productImageURL = '/images/whitetip.jpg' where productId = 14;
UPDATE Product set productImageURL = '/images/darjeeling.jpg' where productId = 15;
UPDATE Product set productImageURL = '/images/chamomile.jpg' where productId = 16;
