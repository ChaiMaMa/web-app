...
UPDATE Product set productImageURL = 'img/genmaicha.jpg' where productId = 6;
UPDATE Product set productImageURL = 'img/dragon well.jpg' where productId = 7;
UPDATE Product set productImageURL = 'img/matcha.jpg' where productId = 8;
UPDATE Product set productImageURL = 'img/sencha.jpg' where productId = 9;
UPDATE Product set productImageURL = 'img/white tip.jpg' where productId = 10;
UPDATE Product set productImageURL = 'img/frozen peak.jpg' where productId = 11;
UPDATE Product set productImageURL = 'img/Wenshan Baozhong Tea.jpg' where productId = 12;
UPDATE Product set productImageURL = 'img/Silver Needle, Organic.jpg' where productId = 13;
UPDATE Product set productImageURL = 'img/white tip.jpg' where productId = 14;
UPDATE Product set productImageURL = 'img/darjeeling.jpg' where productId = 15;
UPDATE Product set productImageURL = 'img/chamomile.jpg' where productId = 16;
UPDATE Product set productImageURL = 'img/ginger.jpg' where productId = 17;
UPDATE Product set productImageURL = 'img/hibiscus.jpg' where productId = 18;
UPDATE Product set productImageURL = 'img/peppermint.jpg' where productId = 19;
UPDATE Product set productImageURL = 'img/rooibos.jpg' where productId = 20;
